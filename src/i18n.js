...
const supportedLanguage = ['en', 'id', 'ru', 'ja', 'ko', 'fr', 'zh', 'pt', 'tw', 'es', 'de', 'th', 'vi', 'tr', 'it', 'la'];
addMessages('en', en);
...
register('la', () => import('./locales/la.json'));
...
register('la', () => import('./locales/items/la.json'));
